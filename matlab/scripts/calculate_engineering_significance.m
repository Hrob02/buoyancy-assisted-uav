...
metricDefinitions = [ ...
    ...
    struct('field', "spatial_footprint_m2", 'label', "spatial_footprint_m2", 'type', "practical metric", 'direction', "lower", 'thresholdField', "footprint_threshold_percent", 'interpretation', "Lower spatial footprint reduces planform obstruction and packaging burden around the UAV."), ...
    struct('field', "max_dimension_m", 'label', "max_dimension_m", 'type', "practical metric", 'direction', "lower", 'thresholdField', "footprint_threshold_percent", 'interpretation', "Lower maximum dimension improves compactness and reduces installation constraints."), ...
    struct('field', "weighted_total_score", 'label', "weighted_total_score", 'type', "decision-screening metric", 'direction', "lower", 'thresholdField', "score_difference_threshold_percent", 'interpretation', "Lower weighted score indicates a better combined design-screening balance across material efficiency, disturbance response, compactness, and practicality."), ...
    struct('field', "manufacturability_score", 'label', "manufacturability_score", 'type', "practical metric", 'direction', "lower", 'thresholdField', "footprint_threshold_percent", 'interpretation', "Lower manufacturability score indicates a simpler assumed implementation path."), ...
    struct('field', "availability_score", 'label', "availability_score", 'type', "practical metric", 'direction', "lower", 'thresholdField', "footprint_threshold_percent", 'interpretation', "Lower availability score indicates lower assumed procurement difficulty.") ...
    ];
...
for metricIndex = 1:numel(metricDefinitions)
    ...
    if ~ismember(metricDefinition.label, ["surface_area_to_volume_ratio", "estimated_envelope_material_mass_kg", ...
            "estimated_net_lift_after_envelope_mass_g", "disturbance_stability_index", "spatial_footprint_m2", ...
