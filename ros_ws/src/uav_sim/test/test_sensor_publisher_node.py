"""Unit tests for SensorPublisherNode (no ROS runtime required)."""

import unittest
from unittest.mock import MagicMock, patch


class TestSensorPublisherNodeImport(unittest.TestCase):
    ...
    def test_module_importable(self) -> None:
        ...
        with patch.dict(
            ...
            mod = importlib.import_module("uav_sim.sensor_publisher_node")
            self.assertTrue(hasattr(mod, "SensorPublisherNode"))
